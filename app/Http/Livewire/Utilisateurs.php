...
class Utilisateurs extends Component
{
    ...
    protected $messages = [
        'newUser.nom.required' => 'Veuillez entrer votre nom svp',
        'newUser.prenom.required' => 'Veuillez entrer votre prénom svp',
        'newUser.email.required' => 'Veuillez entrer votre email svp',
        'newUser.telephone1.required' => 'Veuillez entrer votre numéro de téléphone svp',
        'newUser.pieceIdentite.required' => 'Veuillez selectionner votre pièce',
        'newUser.sexe.required' => 'Veuillez selectionner un sexe',
        'newUser.numeroPieceIdentite.required' => 'Veuillez entrer votre numero de la pièce',
    ];
    ...
    public function addUser()
    {
        ...
        $validationAttributes["newUser"]["password"] = "$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi"; //password
        // $validationAttributes["newUser"]["password"] = bcrypt(request('password'))
